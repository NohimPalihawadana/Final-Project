...
import { clerkUpdateTransactionThunk, clerkFetchMyTransactionsThunk, clerkCreateTransactionThunk } from "@/features/transactions/transactionsSlice"
...
import { UserListItem, fetchOfficers } from "@/features/users/usersService"
import type { TransactionType, Transaction, SubAccount } from "@/types"
import { useState, useEffect, useMemo } from "react"


export default function ClerkTransaction() {

  const dispatch = useAppDispatch()
  const { profile } = useAppSelector((s) => s.auth)
  const { items } = useAppSelector((s) => s.transactions)
